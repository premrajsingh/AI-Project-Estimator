...
class CodeReviewAgent:
    ...
    def review(self, code: str, language: str = "auto") -> dict:
        """
        Args:
        ...
        if self.gemini:
            return self._ai_review(truncated, language, truncated_note)
    ...
    def _ai_review(self, code: str, language: str, truncated: bool) -> dict:
