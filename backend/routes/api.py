...
async def review_code(body: CodeReviewRequest):
    ...
    result   = reviewer.review(body.code, language=body.language or "auto")
    return result
...
async def estimate_planning(
    ...
    valid_exp = {"Beginner", "Intermediate", "Advanced", "Expert"}
    ...
    try:
        ...
        background_tasks.add_task(agent.analyze, data, file_path, file_type, hourly_rate=current_hourly)
